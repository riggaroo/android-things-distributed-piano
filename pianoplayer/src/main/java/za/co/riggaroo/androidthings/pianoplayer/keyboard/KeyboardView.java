...
package za.co.riggaroo.androidthings.pianoplayer.keyboard;
...
public class KeyboardView extends View {
    ...
    public void setMidiListener(KeyBoardListener listener) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < nKeys_; i++) {
            ...
            float x = x0 + ((i / keyboardSpec_.keys.length) * keyboardSpec_.repeatWidth + ks.rect.left) * xscale;
    ...
    /* convert x and y to KeyboardSpec space */
        ...
        for (int i = 0; i < nKeys_; i++) {
            ...
            if (xk >= kx0 && xk < kx0 + ks.rect.width() && yk >= ks.rect.top && yk < ks.rect.bottom) {
                return i + firstKey_;
            }
        }
        return -1;
    ...
    private KeyBoardListener midiListener_;
    ...
    static final String[] NOTE_NAMES = new String[]{"C", "C\u266f", "D", "D\u266f", "E", "F", "F\u266f", "G", "G\u266f", "A", "A\u266f", "B"};
}
